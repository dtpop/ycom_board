...
if (rex::getUser()->isAdmin()) {
    ...
    if (rex_request('install', 'integer') == 1) {
        $input = rex_file::get(rex_path::addon('ycom_board','install/modules/board_input.php'));
        $output = rex_file::get(rex_path::addon('ycom_board', 'install/modules/board_output.php'));
